      ...
      <div className="container max-w-[1440px] 2xl:px-[20px] xl:px-[20px] lg:px-[20px] md:px-[15px] sm:px-[12px] px-[10px] mx-auto">
        ...
        {remainingEvents.length > 0 ? (
          <div className="relative w-full max-w-[1401px] mx-auto">
            ...
            {currentEvents.map((event: any, index: number) => {
              ...
              return (
                ...
                >
                  <img
                    src={event.eventSettings?.eventImages?.[0]?.eventImage?.node?.sourceUrl}
                    alt={event.eventSettings?.eventImages?.[0]?.eventImage?.node?.altText}
                  ...
                  <div className="absolute bottom-0 left-0 right-0 2xl:p-[30px] xl:p-[25px] lg:p-[20px] md:p-[15px] sm:p-[12px] p-[10px] flex justify-between items-start opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    {/* <!-- View More Button --> */}
                    <div className="flex items-center 2xl:gap-[10px] xl:gap-[10px] lg:gap-[8px] md:gap-[7px] sm:gap-[6px] gap-[5px] cursor-pointer hover:opacity-80 transition-opacity opacity-0 group-hover:opacity-100 duration-300">
          ...
          <div className="text-center py-[60px]">
            <p className="text-white text-lg">No additional events to display</p>
          </div>
        )}
      </div>
    </section>
