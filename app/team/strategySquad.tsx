        ...
        >
          <div className="container max-w-[1440px] px-[20px] mx-auto">
            <div className="flex flex-col items-center justify-center gap-[30px] sm:gap-[40px] md:gap-[60px]">
              ...
              <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-[16px] sm:gap-[24px] md:gap-[30px] w-full 2xl:pb-[100px] xl:pb-[100px] lg:pb-0 md:pb-0 sm:pb-0 pb-0">
      ...
      {isPopupOpen && selectedMember && (
        <div className="fixed inset-0 z-50 z-[9999999]">
          ...
          <div
            ...
            style={{ backgroundImage: `url(${selectedMember?.teamSetting.memberDetailBackgroundImage?.node?.sourceUrl})` }}
