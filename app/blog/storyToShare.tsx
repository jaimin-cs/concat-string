    ...
    try {
      ...
      if (form.uploadDocument && fileData) {
        fields[5] = {
          ...
          value: form.uploadDocument.name,
          id: 5,
          type: "file",
          file_data: fileData
        };
          ...
          <div className="min-h-screen px-4 sm:px-6 md:px-10 flex justify-center items-center">
            <div className="w-full max-w-[1400px] 2xl:pt-[80px] xl:pt-[80px] lg:pt-[60px] md:pt-[50px] sm:pt-[40px] pt-[20px] 2xl:pb-[100px] xl:pb-[100px] lg:pb-[6px] md:pb-[50px] sm:pb-[40px] pb-[20px] 2xl:px-[130px] xl:px-[130px] lg:px-[60px] md:px-[50px] sm:px-[40px] px-[20px] bg-[#292929] rounded-[20px] mx-auto max-h-[90vh] overflow-y-auto relative">
              ...
              <div className="flex flex-col gap-[16px] items-center justify-center 2xl:mb-[50px] xl:mb-[50px] lg:mb-[40px] md:mb-[30px] sm:mb-[20px] mb-[20px]">
                <h2 className="font-denton font-bold 2xl:text-[66px] xl:text-[66px] lg:text-[50px] md:text-[40px] sm:text-[30px] text-[30px] 2xl:leading-[87px] xl:leading-[87px] lg:leading-[60px] md:leading-[55px] sm:leading-[35px] leading-[40px] text-center text-white">Get Featured on Our Blog</h2>
                <p className="font-lato font-normal text-[17px] leading-[26px] text-[#C3C3C3]">Share your original content and reach a wider audience.</p>
              </div>
              <form onSubmit={handleFormSubmit} className="flex flex-col items-center justify-center gap-[30px] w-full">
                <div className="grid 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 grid-cols-1 gap-[20px] w-full">
                  <div className="flex flex-col items-start gap-[16px]">
                    <label className="font-lato font-normal text-[17px] leading-[100%] text-white">Name</label>
                    <input 
                      type="text" 
                      name="name"
                  ...
                  <div className="flex flex-col items-start gap-[16px]">
                    <label className="font-lato font-normal text-[17px] leading-[100%] text-white">Email</label>
                    <input 
                      type="email" 
                      name="email"
                  ...
                  <div className="flex flex-col items-start gap-[16px]">
                    <label className="font-lato font-normal text-[17px] leading-[100%] text-white">Blog title</label>
                    <input 
                      type="text" 
                      name="blogTitle"
                  ...
                  <div className="flex flex-col items-start gap-[16px]">
                    <label className="font-lato font-normal text-[17px] leading-[100%] text-white">Blog Content</label>
                  ...
                  <div className="flex flex-col items-start gap-[16px]">
                    <label className="font-lato font-normal text-[17px] leading-[100%] text-white">Tags</label>
                    <input 
                      type="text" 
                      name="tags"
                  ...
                  <div className="flex flex-col items-start gap-[16px]">
                    <label className="font-lato font-normal text-[17px] leading-[100%] text-white">Author Bio</label>
                    <input 
                      type="text" 
                      name="authorBio"
                ...
                {submitMessage && (
                  <div className={`text-center text-[17px] font-lato ${submitMessage.includes("Error") ? "text-red-400" : "text-green-400"}`}>
                    {submitMessage}
                  </div>
                )}
                <button 
