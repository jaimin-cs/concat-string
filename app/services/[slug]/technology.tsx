...
const Technology: React.FC<Props> = ({ data }) => {
  ...
  const techStack = data?.technology?.technologiesSettings?.techStack || [];
  const technologyUseTitle =
    data?.technology?.technologiesSettings?.technologyUseTitle;
  const technologyUsedDescription =
    data?.technology?.technologiesSettings?.technologyUsedDescription;
