          ...
          <div className="flex items-center justify-center 2xl:gap-[40px] xl:gap-[40px] lg:gap-[30px] md:gap-[30px] sm:gap-[20px] gap-[20px] flex-row flex-wrap">
            {industries.map((industry: any, idx: number) => (
              ...
              >
                ...
                <p className="font-lato font-bold 2xl:text-[26px] xl:text-[26px] lg:text-[26px] md:text-[25px] sm:text-[20px] text-[18px] leading-[38px] text-[#252525] w-[calc(100%-24px)] hover:bg-gradient-to-b hover:from-[#E72125] hover:to-[#8E1D1D] hover:bg-clip-text hover:text-transparent transition-colors duration-200">
